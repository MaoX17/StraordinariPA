...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@prvprato1.local";
    ...
    * @var string
    */
	protected $baseDn = "DC=prvprato1,DC=local";
    ...
    * @var array
    */
    protected $domainControllers = array("dc01.prvprato1.local", "virtual2.prvprato1.local");
    ...
    * @var string
    */
	protected $adminUsername = "serviceauthad" ;
    protected $adminPassword = "service_123";
