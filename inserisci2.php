...
if ((ctrl_login_boolean()) && ($_SESSION['idRuolo'] == "1")) {
	...
	//Controllo data lato server

	if (($straordinario->controllaEsistenzaDaRichiesta() == false) AND ($straordinario->controllaDataCorretta() == true)) {
        //echo "22222";
        //var_dump($straordinario);

        $straordinario->creaNelDB();
        $log->riempiObj($utente, $straordinario, "inserimento richiesta straord");
        //var_dump($log);
        $log->creaNelDB();
        $_SESSION['idArea']=$_POST['area'];
?>
        <div class="container">
        ...
        <div class="container">
            <div class="row row-offcanvas row-offcanvas-right">
                ...
                <div class="col-xs-12 col-sm-8">
                    ...
                    <h3>Data inserita antecedente a un mese oppure
						Data gi&agrave; presente! Controlla nelle richieste gi&agrave; inserite</h3>
                    <a href="pannelloUtente.php" class="btn btn-sm btn-success">Torna al pannello</a>
                </div>
            </div>
            <br><br><br>
        </div>
