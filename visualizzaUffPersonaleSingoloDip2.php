...
$where = "";
    ...
    //echo $dip;
    $dip=$_POST['dipendenti']; //ID_UTENTE del DIPENDENTE
    $where=$where." utenti.id_utente = '$dip' ";
...
<table class='table table-striped' border=1 align=center id='table'>
    ...
    $handle = fopen("/var/www/vhosts/personale/straordinari/tmp/RichiesteDipendente.csv", "w");
...
<?php
    echo "<center><a href='./tmp/RichiesteDipendente.csv' id='link'> Clicca qui per scaricare! </a></center><br>";
}
