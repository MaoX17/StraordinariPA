	...
	<div class="container">
	   <div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="col-xs-12 col-sm-8">
				<h2 class="text-danger">Filtra richieste</h2>
				<form role="form" name='myForm' class="form-horizontal"  id='myForm' action="visualizzaUffPersonale2.php" method="post">
                    ...
                    <div class="col-md-4">
                    <select name="ordina" class="form-control">
